...
<body>
    ...
    <section class="hero-banner d-flex align-items-center">
        <div class="fondo-banner-5">

        </div>
        <div class="container text-center" style="z-index: 1;">
            <h2>Zona del Administrador</h2>
            <nav aria-label="breadcrumb" class="banner-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">Inicio</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Zona del Administrador</li>
                </ol>
            </nav>
        </div>
    ...
    <section class="faq_area area-padding-top">
        <blockquote class="generic-blockquote">
            <h1 class="bienvenida">Bienvenido <?php echo  $_SESSION['user']  ?> esta es tu Zona del Administrador</h1>
        </blockquote>
    </section>
        ...
        <div class="">
            ...
            <div class="container">
                <div class="section-top-border">
                    <h2 class="mb-30 title_color">Usuarios Registrados</h2>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <blockquote class="generic-blockquote">
                                ...
                                echo "<table>";
                                $query2 = $this->connect()->prepare('SELECT * FROM usuario');
                                $query2->execute();       
    ...
    <!-- Registro de compras de todos los clientes --->
    <section>
        ...
        <div class="">
            ...
            <div class="container">
                <div class="section-top-border">
                    <h2 class="mb-30 title_color">Compras de los Clientes</h2>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <blockquote class="generic-blockquote">
                                ...
                                $query2 = $this->connect()->prepare('SELECT * FROM compras');
                                $query2->execute();       
                                $arreglo=$query2->fetch(PDO::FETCH_NUM);  
                                while($arreglo=$query2->fetch(PDO::FETCH_NUM)){
                                echo "<tr class='tbl-content'>";
